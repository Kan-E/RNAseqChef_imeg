---
title: "Multi DEG with RNAseqChef-beta v1.1.2"
...
if(params$input$multi_data_file_type == "Row1" && !is.null(params$input$multi_file1)) {
  try(cat(paste0("Count_data: **", params$input$multi_file1$name,"**\n\n")))
}
if(params$input$multi_data_file_type == "Row2" && !is.null(params$input$multi_file2)) {
  try(cat(paste0("Count_data: **", params$input$multi_file2$name,"**\n\n")))
}
```
 ...
 **`r params$input$DEG_method_multi`**
```{r echo = FALSE, results='asis'}
if(params$input$DEG_method_multi == "limma"){
  try(cat(paste0("Trend: **", params$input$limma_trend_multi,"**\n")))
  try(cat(paste0("Regression: **", params$input$regression_mode_multi,"**\n\n")))
  cat("\n")
}
```
