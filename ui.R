    ...
    navbarPage(
      ...
      tabPanel("RNAseqChef_beta" ,value='Title', icon = icon("utensils"),
               fluidRow(
                 ...
                 column(12,
                        br(),
                        h4("Current version (v1.1.1-beta, 2024/8/26)"),
                        p("(2024/8/19) Improve the pre-filtering functions in the pair-wise DEG and MultiDEG."),
                        p("(2024/8/19) Fix bugs regarding ssGSEA in the MultiDEG."),
