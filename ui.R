    ...
    navbarPage(
      ...
      tabPanel("RNAseqChef_beta" ,value='Title', icon = icon("utensils"),
               fluidRow(
                 ...
                 column(12,
                        br(),
                        h4("Difference from official version"),
                        tags$ol(
                          tags$li(HTML("Adjustment for proteome analysis in pair-wise DEG and MultiDEG. When uploding proteome data, you need to select 'limma for normalized count data' from the DEG analysis method in the setting panel.")),
                          tags$li(HTML("ID conversion for transcript-level analysis. When uploading transcript-level count data (e.g. ENTSxxxx or NMxxxx), you need to select 'Transcript level' from the Level in the setting panel.")),
                          tags$li(HTML("Pre-filter function for limma and edgeR.")),
                          tags$li(HTML("Function for ssGSEA in multiDEG analysis.")),
            ...
            font-style: bold;
                              ...
                              fluidRow(
                                column(8, 
                                       ...
                                       htmlOutput("DTU_top"),
                                       htmlOutput("DTU_manual"),
                                       htmlOutput("GOIreset_DTU_manual"))
                              ),
                              downloadButton("download_DRIMSeq_barplot", "Download barplot"),
                              div(
                              ...
                              downloadButton("download_DRIMSeq_GOIboxplot", "Download boxplot"),
      ...
      tabPanel("Multi DEG",
               sidebarLayout(
                 ...
                 sidebarPanel(
                   ...
                   radioButtons('Level_multi','Level:',
                                c('Gene level'="gene_level",
                                  'Transcript level'="transcript_level"
                                ),selected = "gene_level",inline = TRUE),
                 ...
                 tabPanel("Change log",value = "log",
                          fluidRow(
                            column(12,
                                   ...
                                   strong("(2023/8/8) Add 'Select samples' function in Pair-wise DEG, 3 conditions DEG, and Normalized count analysis. 
                                   ...
                                   strong("(2024/9/5) Add a function for transcript-level analysis."),br(),
                                   strong("(2024/9/5) Fix bugs regarding the cnet plot."),br(),
                                   strong("(2024/9/5) Improve the graph design for the boxplot, barplot, and volcano plot."),br(),
                                   strong("(2024/9/5) Fix bugs regarding the ssGSEA in the MultiDEG."),br(),
